...
export default function NotFound() {
  return (
    <main id="main" className="relative isolate grid min-h-svh place-items-center overflow-hidden px-6 text-center">
      ...
      <div>
        ...
        <div className="mt-8 flex justify-center gap-3">
          <Button href="/app/assets" variant="primary">Open the registry</Button>
          <Button href="/" variant="secondary">Home</Button>
        </div>
        <p className="mt-10 font-mono text-[11px] text-ink-4">
          <Link href="/app" className="hover:text-ink-2">/app</Link>
        </p>
      </div>
    </main>
  );
